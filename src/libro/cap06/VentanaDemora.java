...
public class VentanaDemora extends Frame {
    ...
    /**
     * Creates new form VentanaDemora
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaDemora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaDemora().setVisible(true);
            }
        });
    }
